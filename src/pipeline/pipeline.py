...
def main(args):
    ...
    study.optimize(lambda trial: objective(trial), n_trials=args.n_trials, callbacks=[mlflow_callback])
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run the full model training and optimisation pipeline.")
    parser.add_argument('--n_trials', type=int, default=100, help='Number of trials for hyperparameter optimisation.')
